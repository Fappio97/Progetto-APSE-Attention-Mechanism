 ...
 * 
 * gcc -fopenmp att64c.c -lm
 * ./a.out -ds test_2048_48_64.ds -wq test_48_32_64.wq -wk test_48_32_64.wk -wv test_48_32_64.wv -bq test_32_64.bq -bk test_32_64.bk -bv test_32_64.bv -si 8 -n 64
 *
 */
