 ...
 *
 * gcc -fopenmp att32c_omp.c -lm && ./a.out -ds test_2048_48_32.ds -wq test_48_32_32.wq -wk test_48_32_32.wk -wv test_48_32_32.wv -bq test_32_32.bq -bk test_32_32.bk -bv test_32_32.bv -si 8 -n 64
 *
 */
...
#pragma omp parallel for collapse(2) num_threads(max_threads)
	for (int i = 0; i < input->ns; ++i)
	{
		...
		{
			// stampe per vedere il numero del thread su che matrice j-esima del tensore i-esimo lavora
			// int tid = omp_get_thread_num();
			// printf("TDI interno = %d e lavoro sulla matrice j %d del tensore i %d\n", tid, j, i);
